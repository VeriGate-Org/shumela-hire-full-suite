  ...
  return (
    <div className={className}>
      ...
      <div className="mb-5">
        ...
        <button
          onClick={onCreateNew}
          className="mt-3 w-full inline-flex items-center justify-center whitespace-nowrap px-4 py-2 border-2 border-cta text-sm font-medium rounded-full text-cta-on-surface bg-transparent hover:bg-cta hover:text-cta-foreground uppercase tracking-wider transition-colors"
        >
