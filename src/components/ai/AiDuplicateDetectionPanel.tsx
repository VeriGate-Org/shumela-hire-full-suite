  ...
  return (
    <div className="space-y-3">
      ...
      {checked && duplicates.length === 0 && (
        <div className="text-xs text-green-700 bg-green-50 border border-green-200 rounded-control px-3 py-2">
          {message}
        </div>
      )}
      ...
      {duplicates.length > 0 && (
        <div className="space-y-2">
          <div className="text-xs text-orange-700 bg-orange-50 border border-orange-200 rounded-control px-3 py-2">
            {message}
          </div>
          {duplicates.map((dup, i) => (
            <div key={i} className="flex items-center justify-between p-3 bg-gray-50 border border-gray-200 rounded-control">
              <div>
