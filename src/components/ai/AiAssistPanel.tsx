  ...
  return (
    <FeatureGate feature="AI_ENABLED">
      <FeatureGate feature={feature}>
        <div className="border border-gray-200 rounded-control bg-white overflow-hidden">
          ...
          >
            {/* Sparkle icon */}
            <div className="w-7 h-7 rounded-control bg-teal-50 flex items-center justify-center flex-shrink-0">
