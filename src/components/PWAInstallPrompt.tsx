          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                Install <span data-logotype className="text-primary">Shumela</span><span data-logotype className="text-cta">Hire</span>
              </h3>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-600 mt-1">
                Add <span className="font-semibold"><span data-logotype className="text-primary">Shumela</span><span data-logotype className="text-cta">Hire</span></span> to your desktop for quick access and offline support.
              </p>
