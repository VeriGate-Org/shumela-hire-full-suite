...
export const applicationStatusConfig: Record<string, StatusConfig> = {
  applied: { color: 'bg-violet-100 text-violet-800 border-violet-300', icon: ClockIcon, label: 'Applied' },
  ...
  interview_scheduled: { color: 'bg-violet-100 text-violet-800', icon: CalendarIcon, label: 'Interview Scheduled' },
...
export const pipelineStageConfig: Record<string, StatusConfig> = {
  applied: { color: 'bg-violet-100 text-violet-800', icon: PaperAirplaneIcon, label: 'Applied' },
...
export const pipelineApplicationStatusConfig: Record<string, StatusConfig> = {
  active: { color: 'bg-violet-100 text-violet-800', icon: ClockIcon, label: 'Active' },
...
export const interviewStatusConfig: Record<string, StatusConfig> = {
  ...
  scheduled: { color: 'bg-violet-100 text-violet-800 border-violet-300', icon: CalendarIcon, label: 'Scheduled' },
...
export const auditActionConfig: Record<string, StatusConfig> = {
  ...
  update: { color: 'bg-violet-100 text-violet-800', icon: ArrowPathIcon, label: 'Update' },
...
export const auditSeverityConfig: Record<string, StatusConfig> = {
  info: { color: 'bg-violet-100 text-violet-800', icon: InformationCircleIcon, label: 'Info' },
