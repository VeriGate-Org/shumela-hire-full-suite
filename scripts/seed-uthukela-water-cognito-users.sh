...
create_user "admin@uthukela.shumelahire.co.za"          "Pieter"    "Botha"     "ADMIN"
create_user "hr.manager@uthukela.shumelahire.co.za"      "Nomvula"   "Nzimande"  "HR_MANAGER"
create_user "executive@uthukela.shumelahire.co.za"       "Sizwe"     "Mthembu"   "EXECUTIVE"
create_user "line.manager@uthukela.shumelahire.co.za"    "John"      "van Wyk"   "HIRING_MANAGER"
create_user "employee@uthukela.shumelahire.co.za"        "Thandi"    "Moyo"      "EMPLOYEE"
...
echo "    Line Manager:   line.manager@uthukela.shumelahire.co.za"
