...
public class TrainingEvaluationItem {
    private String pk;
    private String sk;
    ...
    @DynamoDbAttribute("overallRating")
    ...
    @DynamoDbAttribute("contentRating")
    ...
    @DynamoDbAttribute("instructorRating")
    ...
    @DynamoDbAttribute("relevanceRating")
