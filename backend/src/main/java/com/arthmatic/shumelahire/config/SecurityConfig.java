    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers(new AntPathRequestMatcher("/api/lookups/**")).permitAll()
                ...
                .requestMatchers(new AntPathRequestMatcher("/api/interviews/application/**")).hasAnyRole("ADMIN", "HR_MANAGER", "RECRUITER", "HIRING_MANAGER", "INTERVIEWER", "APPLICANT", "EMPLOYEE")
                ...
                .requestMatchers(new AntPathRequestMatcher("/api/applications/**")).hasAnyRole("ADMIN", "HR_MANAGER", "RECRUITER", "HIRING_MANAGER", "INTERVIEWER", "APPLICANT", "EMPLOYEE")
                ...
                // Offer endpoints
                .requestMatchers(new AntPathRequestMatcher("/api/offers/**")).hasAnyRole("ADMIN", "HR_MANAGER", "HIRING_MANAGER", "APPLICANT", "EMPLOYEE")
