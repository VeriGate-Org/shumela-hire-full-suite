-- ============================================================================
-- V019: Seed HRMS Module Features for Multi-Tenant Feature Gating (SQL Server)
-- ============================================================================
-- Mirrors PostgreSQL migration V033 for hybrid/on-premises deployments.
-- ============================================================================
...
VALUES ('LEAVE_MANAGEMENT', 'Leave Administration',
        ...
        'hr_core', 'STARTER,STANDARD,ENTERPRISE', 1);
...
VALUES ('TRAINING_MANAGEMENT', 'Training & Development',
        ...
        'talent_development', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('LMS_INTEGRATION', 'LMS Integration',
        ...
        'talent_development', 'ENTERPRISE', 1);
...
VALUES ('EMPLOYEE_ENGAGEMENT', 'Employee Engagement',
        ...
        'engagement', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('POPIA_COMPLIANCE', 'POPIA Compliance Management',
        ...
        'compliance', 'STARTER,STANDARD,ENTERPRISE', 1);
...
VALUES ('LABOUR_RELATIONS', 'Labour Relations Management',
        ...
        'compliance', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('SAGE_300_PEOPLE', 'Sage 300 People Integration',
        ...
        'integrations', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('WORKFLOW_MANAGEMENT', 'Workflow Management',
        ...
        'automation', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('ADVANCED_ANALYTICS', 'Advanced HR Analytics',
        ...
        'analytics', 'STANDARD,ENTERPRISE', 1);
...
VALUES ('REPORT_EXPORT', 'Report Export (PDF/Excel)',
        ...
        'analytics', 'STARTER,STANDARD,ENTERPRISE', 1);
