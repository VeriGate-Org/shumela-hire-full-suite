...
public sealed class EnvironmentConfig
{
    ...
    public string[] ApiCorsOrigins => EnvironmentName switch
    {
        ...
        "dev" => new[] { $"https://dev.{DomainName}", $"https://idc-demo.{DomainName}", $"https://uthukela-demo.{DomainName}", $"https://demo.{DomainName}", "http://localhost:3000" },
    ...
    public string[] OAuthCallbackUrls => EnvironmentName switch
    {
        ...
        "dev" => new[] { $"https://dev.{DomainName}/login", $"https://idc-demo.{DomainName}/login", $"https://uthukela-demo.{DomainName}/login", $"https://demo.{DomainName}/login", "http://localhost:3000/login" },
